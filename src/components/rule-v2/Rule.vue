<template>
  ...
  >
    ...
    <!-- <img v-if="isHome" class="rule_line" src="./assets/red_line.png" alt /> -->
    <!-- <div v-if="isHome" class="rule_shadow_bottom"></div> -->
    <!-- <img v-else class="rule_shadow" src="./assets/bg.png" alt /> -->
        ...
        <div class="rule_body_contianer">
          <div class="rule_body">
            <div
              ...
              :key="index"
              class="rule_one"
              style="width: 1px;margin-right: 4px;"
            >
      ...
      loadScripts(['/common/vendor/iscroll-5.2.0/iscroll-probe.js']).then(
        () => {
          _this.$nextTick(() => {
            ...
            _this.oneW = 5 /* base.calculate(totalW, _this.arr.length - 1, '/') */

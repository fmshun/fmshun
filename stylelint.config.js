module.exports = {
  ...
  rules: {
    ...
    // Enforce camelCase for classes and ids, to work better with CSS modules
    // 'selector-class-pattern': /^[a-z][a-zA-Z]*(-(enter|leave)(-(active|to))?)?$/,
    // 'selector-id-pattern': /^[a-z][a-zA-Z]*$/,

    // Enforce kebab-case for classes and ids 定制
    // 'selector-class-pattern': /^[a-z][a-zA-Z0-9]*(-[a-zA-Z0-9]+)*(-(enter|leave)(-(active|to))?)?$/,

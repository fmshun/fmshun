<template>
  <div id="target_set">
    <!-- loading -->
    <waiting v-show="!is5882 && !isInfo"></waiting>
...
export default {
  ...
  methods: {
    ...
    getRouterData() {
      // 产品代码
      this.prdtCode = this.$route.params.prdtCode
      // 产品id
      this.prdtId = this.$route.params.prdtId
      this.resultData.prdtId = this.prdtId
      // 收益率
      this.yieldNum = this.$route.params.yieldNum
    },
    // ----------初始化
    init() {
      // 初始化web头
